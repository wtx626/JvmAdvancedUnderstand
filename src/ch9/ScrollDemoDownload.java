...
public class ScrollDemoDownload extends JPanel
    ...
    public class DrawingPane extends JPanel {
        protected void paintComponent(Graphics g) {
            ...
            System.out.println("paint---"+circles.size());
            Rectangle rect;
    ...
    private static void createAndShowGUI() {
        ...
        JComponent newContentPane = new ScrollDemoDownload();
